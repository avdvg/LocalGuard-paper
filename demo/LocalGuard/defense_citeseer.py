...
# adj, feature, adj_train, _, _, test_edges, test_edges_false, labels = load_ccpdata('citeseer')
# feature = torch.tensor(feature.todense())
#
# adj = save_variable(adj, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj.txt')
# feature = save_variable(feature, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_feature.txt')
# adj_train = save_variable(adj_train, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj_train.txt')
# test_edges = save_variable(test_edges, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_test_edges.txt')
# test_edges_false = save_variable(test_edges_false, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer__test_edges_false.txt')
# labels = save_variable(labels, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer__test_labels.txt')
# print('saving')

adj = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj.txt')
feature = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_feature.txt')
adj_train = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj_train.txt')
test_edges = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_test_edges.txt')
test_edges_false = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer__test_edges_false.txt')
labels = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer__test_labels.txt')
...
adj_A = save_variable(adj_A, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj_A.txt')
adj_B = save_variable(adj_B, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj_B.txt')
adj_A_link = save_variable(adj_A_link, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj_A_link.txt')
feature_A = save_variable(feature_1, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_feature_1.txt')
feature_B = save_variable(feature_2, '/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_feature_2.txt')
print('saving2')


adj_A = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj_A.txt')
adj_B = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj_B.txt')
adj_A_link = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_adj_A_link.txt')
feature_1 = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_feature_1.txt')
feature_2 = load_variavle('/data0/BigPlatform/FL/lirongchang/localguard/tmp/citeseer_feature_2.txt')
...
class SplitNN(nn.Module):
    ...
    def forward(self, x, stage, epoch):
        for i in range(len(x)):
            ...
            if i == 1 and stage=='train' and epoch==99:
                noise = LocalGuard(self.output[i], epoch, stage, train_privacy_property)
                self.output[i] = self.output[i] + 1*noise.detach()

            if epoch == 99 and stage=='train':
                torch.save(self.output[1], 'citeseer_embedding_train.pth')
...
def create_models(partition, input_size, hidden_sizes, output_size):
    ...
    for _ in range(1, partition):
        models.append(GCN(nfeat=1851, nhid=128, nclass=hidden_sizes[1]).cuda())
...
def adversary():
    ...
    adv_train = torch.load('citeseer_embedding_train.pth').cuda()
    adv_test = torch.load('citeseer_embedding_train.pth').cuda()
    ...
    AttackModel = Adv_class(latent_dim=128, target_dim=6).cuda()
    ...
    know_port, acc, f1 = adversary_class_test(optim_, AttackModel, adv_test, test_privacy_property.cuda())
